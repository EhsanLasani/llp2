...
;
;
/** Build dataset from a single source of truth (products map) */ const productItems = Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"]).map((p)=>({
        title: p.title,
        caption: p.subtitle,
...
function CategoryRail({ data = defaultData, title = "A library you’ll want to get lost in.", subtitle = "Browse our products, services, and capabilities.", autoScroll = true, scrollStep = 1.5, scrollInterval = 16 }) {
    ...
    const idleReset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    /** Infinite auto-scroll loop that resets when reaching mid-point */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CategoryRail.useEffect": ()=>{
            ...
            const onUserStart = {
                "CategoryRail.useEffect.onUserStart": ()=>{
                    ...
                    }["CategoryRail.useEffect.onUserStart"], 600);
                }
            }["CategoryRail.useEffect.onUserStart"];
...
_s(CategoryRail, "Vzke+rtiUDQJRZpTgfI7NQr5iSA=");
_c = CategoryRail;
var _c;
__turbopack_context__.k.register(_c, "CategoryRail");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_ef6bddf0._.js.map